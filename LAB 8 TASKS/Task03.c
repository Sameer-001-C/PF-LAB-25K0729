...
int main(){
	...
	for(i = 0; i < size1; i++){ //Array1[i] will first select first element of Array1 and see if it is present anywhere in Array2, then second element of Array1 and so on..
		for(j = 0; j < size2; j++){
